...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'd0df0a9dfc534d54b1821916c9360ac4',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '城市中的游牧者\n出租屋里的穴居人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.zslo.top', // 网站地址
  ...
  GREETING_WORDS_BACK_SPEED:
    process.env.NEXT_PUBLIC_GREETING_WORDS_BACK_SPEED || 300,
